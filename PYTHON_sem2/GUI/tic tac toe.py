...
while True:
    ...
    if q=="y" or q=="Y":
        ...
        l2=[' ',' ',' ']
        l3=[' ',' ',' ']
        pn1=input("Enter player 1 name : ").upper()
        pn2=input("Enter Player 2 Name : ").upper()
        rs=random.randint(0,1)
        if rs==0:
            s1="X"
            s2="O"
            print(f'{pn1} your sign is ',s1)
            print(f'{pn2} your sign is ',s2)
        else:
            s1="O"
            s2="X"
            print(f'{pn1} your sign is ',s1)
            ...
            if l1[0]==l1[1]==l1[2]==s or l1[2]==l2[2]==l3[2]==s or l3[0]==l3[1]==l3[2]==s\
               ...
               or l1[2]==l2[1]==l3[0]==s or l1[1]==l2[1]==l3[1]==s:
                ...
                if w_p==1:
                	...
                	print(f'Hurray! {pn2} Win the Match\n')
                return False
            else:
                return True
        w=True
        while w:
            ...
            if p1 not in ["1","2","3","4","5","6","7","8","9"]:
                print(input(f' {pn1} Please enter position (1-9) : '))
                continue
            elif 48<ord(p1)<58:
                p1=int(p1)
                if p1 not in r:
            ...
            if len(r)<9:
                while w==True:
                    p2=input(f' {pn2}  enter your position (1-9) : ')
